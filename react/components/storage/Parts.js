...
class Parts extends React.Component {
  ...
  render() {
    ...
    let qr_code = <div style={{margin: '50px'}} ><p>Serial #: {this.props.stored_item.serial_number} Name: {this.props.stored_item.name}</p><QRCode value={this.props.stored_item.qr_code_string} size={256}/></div>
